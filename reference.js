...
// @downloadURL https://update.greasyfork.org/scripts/329484/%E8%B1%86%E7%93%A3%E8%B5%84%E6%BA%90%E4%B8%8B%E8%BD%BD%E5%A4%A7%E5%B8%88%EF%BC%9A1%E7%A7%92%E6%90%9E%E5%AE%9A%E8%B1%86%E7%93%A3%E7%94%B5%E5%BD%B1%7C%E9%9F%B3%E4%B9%90%7C%E5%9B%BE%E4%B9%A6%E4%B8%8B%E8%BD%BD.user.js
// @updateURL https://update.greasyfork.org/scripts/329484/%E8%B1%86%E7%93%A3%E8%B5%84%E6%BA%90%E4%B8%8B%E8%BD%BD%E5%A4%A7%E5%B8%88%EF%BC%9A1%E7%A7%92%E6%90%9E%E5%AE%9A%E8%B1%86%E7%93%A3%E7%94%B5%E5%BD%B1%7C%E9%9F%B3%E4%B9%90%7C%E5%9B%BE%E4%B9%A6%E4%B8%8B%E8%BD%BD.meta.js
// ==/UserScript==
...
<div class="rating_more" style="display:none"></div>`); // 修复部分情况$("div.rating_betterthan")不存在情况
            ...
            if (_version === "完整版") {
                ...
                site_map.push({
                    ...
                    label: [
                        ...
                        { name: "HDDolby", link: 'https://www.hddolby.com/torrents.php?incldead=1&search_area=1&notnewword=1&search=' + neizhan, },
                ...
                site_map.push({
                    ...
                    label: [
                        ...
                        { name: "UBits", link: 'https://ubits.club/torrents.php?incldead=1&search_area=1&notnewword=1&search=' + neizhan, },
                        { name: "WinSaku", link: 'https://wintersakura.net/torrents.php?incldead=1&search_area=1&notnewword=1&search=' + neizhan, },
                ...
                site_map.push({
                    ...
                    label: [
                        ...
                        { name: "OKPT", link: 'https://www.okpt.net/torrents.php?incldead=1&search_area=1&notnewword=1&search=' + neizhan, },
                        { name: "PT分享站", link: 'https://pt.itzmx.com/torrents.php?incldead=1&search_area=1&notnewword=1&search=' + neizhan, },
                        { name: "UltraHD", link: 'https://ultrahd.net/torrents.php?incldead=1&search_area=1&notnewword=1&search=' + neizhan, },
                        { name: "库非", link: 'https://kufei.org/torrents.php?incldead=1&search_area=1&notnewword=1&search=' + neizhan, },
                    ]
                });
                if (is_anime) {
                    site_map.push({
                ...
                site_map.push({
                    ...
                    label: [
                        ...
                        { name: "ZX", link: 'http://pt.zhixing.bjtu.edu.cn/search/x' + zxid + '/', selector: "table.torrenttable > tbody > tr:gt(1)" },
                    ]
                });
                site_map.push({
                    name: "PT影视原声",
                    label: [
                        ...
                        { name: "Red", link: 'https://redacted.ch/torrents.php?searchstr=' + eng_title, selector: "tr.group_torrent.edition_1" },
                    ]
                });
                site_map.push({
                    name: "PT影视外站",
            ...
            if (_version === "完整版" && has_imdb) {
                ...
                if (_version === "完整版" && (!(is_mandarine) || (is_mandarine && is_otherlan))) {
                    site_map.push({
                        name: "PT影视字幕",
                        label: [
                            ...
                            { name: "HDAtmos®", link: 'https://hdatmos.club/subtitles.php?notnewword=1&search=' + ptzimu, selector: "table[width='940'][border='1'][cellspacing='0'][cellpadding='5'] > tbody > tr:nth-child(2)" },
            ...
            site_map.push({
                ...
                label: [
                    ...
                    { name: '阿里小站', link: 'https://pan666.net/?q=' + unititle, selector: 'ul.DiscussionList-discussions > li[data-id]' },
                    // { name: '分派电影', link: 'https://www.howgo.cc/forums/search/' + unititle, selector: '.page-title' },
            ...
            site_map.push({
                name: "在线中文影视",
                label: [
                    { name: '万佳影视', link: 'https://www.wjys.cc/vodsearch/wd/' + unititle + '.html', selector: 'div.module-items'},
            ...
            if (!(is_mandarine) || (is_mandarine && is_otherlan)) {
                site_map.push({
                    ...
                    label: [
                        ...
                        { name: '中文字幕网', link: 'https://cn.zimuzimu.net/so_zimu.htm?q=' + unititle, selector: "table.sublist a.othersub" },
                    ]
                });
            }
            if (!(is_mandarine) || (is_mandarine && is_otherlan)) {
            ...
            site_map.push({
                name: "有声在线试听",
                label: [
                    { name: '懒人听书', link: 'https://www.lrts.me/search/book/' + title, selector: 'ul li.book-item' },
                    { name: '评书吧', link: 'http://www.pingshu8.com/search/1.asp?keyword=' + gtitle, selector: "table.TableLine div[align='left']" },
                    { name: '天方听书网', link: 'https://www.tingbook.com/search/' + title, selector: 'ul.search_result_list h4.clearfix' },
                    { name: '中文听书网', link: 'https://www.tingzh.com/search.php?searchword=' + gtitle, selector: 'div.sear_height a.play' },
                    { name: '喜马有声', link: 'https://www.ximalaya.com/so/' + title + '/', selector: `div.xm-album-cover__wrapper + a[title*='${title}']` },
                ]
            });
            site_map.push({
                name: "图书有声网站",
    ...
    $("#drdm_setting_btn").click(function () {
        ...
        wrapper_change("drdm_setting", int_html, function () {
            ...
            config_setting_gen("额外样式", "enable_extra_stylesheet", "注入一些额外的CSS样式屏蔽豆瓣广告等（注意：这会隐藏豆瓣自带的观影渠道）", true);
